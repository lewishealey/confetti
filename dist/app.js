  ...
  render: function() {
		...
		if(this.props.user.events) {
			...
			var eventOptions = Object.keys(this.props.user.events).map(function (key, i) {
				return React.createElement(Choice, {key: key, id: key, value: i, name: this.props.user.events[key].name, handleChoice: this.handleChoice, open: this.props.open})
			}.bind(this));
		} else {
		...
		return React.createElement("div", {className: "add " + (this.props.open ? "active" : "not")}, 
			React.createElement("div", {className: "add__main"}, 

				React.createElement("div", {className: "row"}, 
					React.createElement("div", {className: "col-md-6"}, 
						React.createElement("h2", {className: "add__title"}, "Add ", type)
					), 
						React.createElement("img", {className: "add__close", src: "https://firebasestorage.googleapis.com/v0/b/boiling-fire-2669.appspot.com/o/close.png?alt=media&token=a2250bd0-d07a-4ffc-b10b-cf9c08566932", onClick: this.handleOpen})
				), 
					...
					React.createElement("div", null, 
						React.createElement("div", {className: "row"}, 
							React.createElement("div", {className: "col-md-12"}, 
									React.createElement("p", null, React.createElement("input", {type: "text", className: "form-control", placeholder: "Enter First Name", ref: "fName", name: "fname"}))
							), 
							React.createElement("div", {className: "col-md-12"}, 
									React.createElement("p", null, React.createElement("input", {type: "text", className: "form-control", placeholder: "Enter Surname", ref: "lName", name: "lname"}))
							), 

							React.createElement("div", {className: "col-md-12"}, 
								React.createElement("h5", null, "What event/s are they invited to?"), 
								eventOptions
							), 

							React.createElement("div", {className: "col-md-12 add__cta"}, 
								React.createElement("a", {className: "btn btn--gold", onClick: this.handleGuest}, "Add Guest"), React.createElement("a", {className: "btn btn--trans", onClick: this.handleOpen}, "Cancel")
							)
				...
				this.props.type == "event" &&
					...
					React.createElement("div", null, 
						React.createElement("div", {className: "row"}, 
							React.createElement("div", {className: "col-md-12"}, 
									React.createElement("input", {type: "text", className: "form-control", placeholder: "Enter event name", ref: "eventName"})
							)
						), 
						...
						React.createElement("div", {className: "row"}, 
							React.createElement("div", {className: "col-md-6"}, 
								...
								React.createElement("input", {type: "text", className: "form-control", placeholder: "00:00", ref: "eventFTime"})
							), 
							React.createElement("div", {className: "col-md-6"}, 
								React.createElement("label", null, "To"), 
								React.createElement("input", {type: "text", className: "form-control", placeholder: "06:00", ref: "eventTTime"})
							)
						), 

						React.createElement("label", null, "Address"), 
						React.createElement("input", {type: "text", className: "form-control", placeholder: "Address", ref: "eventAddress", name: "address"}), React.createElement("br", null), 

						React.createElement("label", null, "Postcode"), 
						React.createElement("input", {type: "text", className: "form-control", placeholder: "Postcode", ref: "eventPostcode", name: "postcode"}), React.createElement("br", null), 

						React.createElement("h5", null, "Add a course"), 
						React.createElement("p", null, React.createElement("input", {type: "text", className: "form-control", placeholder: "Enter meal name", ref: "courseName"}), 
						React.createElement("a", {className: "btn btn-default", onClick: this.handleCourse}, "Add course")), 

						React.createElement("div", null, 
							React.createElement("h5", null, "Add meals to course"), 
							React.createElement("select", {className: "form-control", ref: "courseSelect"}, 
								Object.keys(this.state.course).map(function (key, i) {
									return React.createElement("option", {key: i, value: key}, this.state.course[key].name)
								}.bind(this))
							), 
							React.createElement("input", {type: "text", className: "form-control", placeholder: "Enter meal name", ref: "mealName"}), 
							React.createElement("a", {className: "btn btn-default", onClick: this.handleMeal}, "Add meal")
						), 

						React.createElement("div", {className: "row"}, 

							React.createElement("div", {className: "col-md-12 add__cta"}, 
								React.createElement("button", {className: "btn btn--gold", onClick: this.handleAddEvent}, "Add Event"), React.createElement("a", {className: "btn btn--trans", onClick: this.handleOpen}, "Cancel")
							)
  ...
  render: function() {
    ...
    if (this.state.loggedIn && this.state.user) {
      return React.createElement("div", null, 
				...
				React.createElement(Alert, {delay: 2000, type: this.state.popup.type}, this.state.popup.text), 

				React.createElement(Add, {type: this.state.type, action: this.state.action, user: this.state.user, handleEvent: this.handleEvent, handleGuest: this.handleGuest, handleOpen: this.handleOpen, open: this.state.open, handlePopup: this.handlePopup}), 
				React.createElement(Dashboard, {user: this.state.user, handleLogout: this.handleLogout, handleGuest: this.handleGuest, handleAction: this.handleAction, handleEvent: this.handleEvent, handleCutoff: this.handleCutoff, handlePopup: this.handlePopup}, this.props.children))
            // return <div><h4>Logged in</h4></div>
    } else {

    // Else show login or register form
      return React.createElement("div", {className: "login"}, 
        React.createElement("div", {className: "login__main"}, 
              React.createElement(Login, {login: this.onLoginSubmit, loading: this.state.loaded}), 

								React.createElement("div", {className: "login__cta"}, 
			            React.createElement(Register, {register: this.onRegisterSubmit, loading: this.state.loaded})
			          )
...
var routes = (
  React.createElement(Router, {history: new HashHistory}, 
      React.createElement(Route, {path: "/", component: App}, 
        React.createElement(Route, {path: "guests", component: Guests}), 
        React.createElement(Route, {path: "events", component: Events}), 
        React.createElement(Route, {path: "settings", component: Settings})
      ), 
      React.createElement(Route, {path: "page", component: View}, 
          React.createElement(Route, {path: ":userId/:guestId", component: ViewGuest}), 
          React.createElement(Route, {path: ":userId", component: ViewUser})
      )
  )
  )
